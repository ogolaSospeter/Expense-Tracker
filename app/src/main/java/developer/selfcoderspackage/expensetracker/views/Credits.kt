...
fun Credits(navController: NavHostController) {
    ...
    var sortedcreditList by remember { mutableStateOf(emptyList<Credits>()) }
    ...
    LaunchedEffect(sortOrder) {
        ...
        sortedcreditList = viewmodel.getCreditsFromFirestore(sortOrder)
